...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginTV = (TextView) findViewById(R.id.go_login);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("Users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(RegisterActivity.this, "Поздравляем, аккаунт успешно создан", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(RegisterActivity.this, "Ошибка сети. Попробуйте позднее", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
                else
                {
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "Попробуйте с другим номером", Toast.LENGTH_SHORT).show();
